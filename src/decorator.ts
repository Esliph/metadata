import { Decorator, DecoratorOptions, ClassDecoratorHandler, AttributeDecoratorHandler, ParameterDecoratorHandler, MethodDecoratorHandler } from '@esliph/decorator'
...
export class DecoratorMetadata {
    ...
    static Create = {
        Class: (options: Partial<DecoratorMetadataOptions> = {}, ...handlers: ClassDecoratorHandler[]) =>
        ...
        Attribute: (options: Partial<DecoratorMetadataOptions> = {}, ...handlers: AttributeDecoratorHandler[]) =>
        ...
        Method: (options: Partial<DecoratorMetadataOptions> = {}, ...handlers: MethodDecoratorHandler[]) =>
        ...
        Parameter: (options: Partial<DecoratorMetadataOptions> = {}, ...handlers: ParameterDecoratorHandler[]) =>
